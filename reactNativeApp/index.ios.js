...
import MapPage from './iosView/mapPage'
import Read from './iosView/read'
import Weather from './iosView/weather'
import Settings from './iosView/settings'
...
export default class reactNativeApp extends Component {
  ...
  _renderView(){
    ...
    switch(this.state.tabName){
      ...
      case 'read' : view =<Read/> ; break;
      case 'weather' : view =<Weather/> ; break;
      default : view = <Settings/> ; break;
    }
    return view
  }
  render() {
        ...
        <TabBarIOS
         ...
         translucent={true}
          ...
          <TabBarIOS.Item
            ...
            selected={this.state.tabName==='map'}
            onPress={()=>{
              this.setState({
                tabName:'map'
              })
          ...
          <TabBarIOS.Item
           ...
           selected={this.state.tabName==='read'}
           onPress={()=>{
             this.setState({
               tabName:'read'
             })
          ...
          <TabBarIOS.Item
           ...
           selected={this.state.tabName==='weather'}
           onPress={()=>{
             this.setState({
               tabName:'weather'
             })
          ...
          <TabBarIOS.Item
           ...
           selected={this.state.tabName==='settings'}
           onPress={()=>{
             this.setState({
               tabName:'settings'
             })
